...
leo_resp1 = Response.create!(user_id: leo.id, answer_id: food_q1_a4.id)
leo_resp2 = Response.create!(user_id: leo.id, answer_id: food_q2_a3.id)
leo_resp3 = Response.create!(user_id: leo.id, answer_id: food_q3_a4.id)
...
cat_resp3 = Response.create!(user_id: cat.id, answer_id: music_q1_a3.id)
cat_resp3 = Response.create!(user_id: cat.id, answer_id: music_q2_a3.id)
cat_resp3 = Response.create!(user_id: cat.id, answer_id: music_q3_a1.id)